...
export const fetchCategorytype = async () => {
  try {
    const response = await axios.get(
      `${API_BASE}Categorytype/LoadCategorygrid`,
    );
    return response.data;
  } catch (error) {
    console.error("Error fetching departments:", error);
...
export const saveCategorytype = async (payload: any) => {
  try {
    const response = await axios.post(
      `${API_BASE}Categorytype/CategorytypeSave`,
      payload,
    );
    return response.data;
  } catch (error) {
...
export const fetchDesignationList = async (workmode: string) => {
  try {
    const response = await axios.post(
      `${API_BASE}DesignationMaster/Designationlist`,
      { WorkMode: workmode },
    );
    return response.data;
  } catch (error) {
...
export const SaveDesignation = async (payload: any) => {
  try {
    const response = await axios.post(
      `${API_BASE}DesignationMaster/SaveDesignation`,
      payload,
    );
...
export const DeleteDesignation = async (payload: any) => {
  const response = await axios.post(
    `${API_BASE}DesignationMaster/DeleteDesignation`,
    payload,
  );
  return response.data;
};
...
export const SaveDesignationOrder = async (payload: any) => {
  const response = await axios.post(
    `${API_BASE}DesignationMaster/SaveDesignationOrder`,
    payload,
  );
  return response.data;
};
