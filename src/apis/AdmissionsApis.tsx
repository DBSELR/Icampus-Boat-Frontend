...
export const getExpenditureStudentDetails = async (regNo: string) => {
  try {
    const response = await axios.get(
      `${API_BASE}Expenditure/student-details/${encodeURIComponent(regNo)}`,
    );
    return response.data;
  } catch (error) {
    console.error("Get Expenditure Student Details Error:", error);
    throw error;
  }
};

export const saveExpenditure = async (payload: {
  regNo: string;
  studentName: string;
  course: string;
  academicYear: string;
  ...
  try {
    const response = await axios.post(`${API_BASE}Expenditure/save`, payload);
    return response.data;
  } catch (error) {
...
export const getExpenditurePrintData = async (
  regNo: string,
  academicYear: string,
) => {
  try {
    const response = await axios.get(`${API_BASE}Expenditure/print-data`, {
      params: {
        regNo,
        academicYear,
      },
    ...
    console.error("Get Expenditure Print Data Error:", error);
    throw error;
  }
};
...
export const getStudentGroupDetails = async (regNo: string) => {
  try {
    const response = await axios.get(
      `${API_BASE}GroupChange/student-details/${encodeURIComponent(regNo)}`,
    );
    return response.data;
  } catch (error) {
...
export const validateNewRegNo = async (
  ...
  try {
    const response = await axios.get(
      `${API_BASE}GroupChange/validate-new-regno`,
      {
...
export const getBonafideStudentDetails = async (regNo: string) => {
  try {
    const response = await axios.get(
      `${API_BASE}Bonafide/registration-details/${encodeURIComponent(regNo)}`,
    );
    return response.data;
  } catch (error) {
...
export const getBonafideReport = async (
  id: string,
  ssNo: string,
  certificateNo: string,
) => {
...
export const getStudyCertificateStudentDetails = async (regNo: string) => {
  try {
    const response = await axios.get(
      `${API_BASE}StudyCertificate/student-details/${encodeURIComponent(regNo)}`,
    );
    return response.data;
  } catch (error) {
    console.error(
      "Error while fetching Study Certificate student details",
      error,
    );
    throw error;
  }
...
export const saveStudyCertificate = async (payload: {
  ...
  try {
    const response = await axios.post(
      `${API_BASE}StudyCertificate/save`,
      payload,
    );
    return response.data;
  } catch (error) {
...
export const deleteStudyCertificate = async (id: string) => {
  try {
    const response = await axios.delete(
      `${API_BASE}StudyCertificate/delete/${id}`,
    );
    return response.data;
  } catch (error) {
...
export const getStudyCertificatePrintData = async (
  id: string,
  ssno: string,
) => {
  try {
...
export const getCourseCompletedStudentDetails = async (regNo: string) => {
  try {
    const response = await axios.get(
      `${API_BASE}CourseCompleted/student-details/${encodeURIComponent(regNo)}`,
    );
    return response.data;
  } catch (error) {
    console.error(
      "Error while fetching Course Completed student details",
      error,
    );
    throw error;
  }
...
export const deleteCourseCompleted = async (id: string) => {
  try {
    const response = await axios.delete(
      `${API_BASE}CourseCompleted/delete/${id}`,
    );
    return response.data;
  } catch (error) {
...
export const loadNoObjectionCertificateData = async (academicYear?: string) => {
  try {
    ...
    console.error(
      "Error while loading No Objection Certificate initial data",
      error,
    );
    throw error;
  }
...
export const getNoObjectionCertificateStudentDetails = async (
  regNo: string,
) => {
  try {
    const response = await axios.get(
      `${API_BASE}NoObjectionCertificate/student-details/${encodeURIComponent(regNo)}`,
    );
    return response.data;
  } catch (error) {
    console.error(
      "Error while fetching No Objection Certificate student details",
      error,
    );
    throw error;
  }
...
export const saveNoObjectionCertificate = async (payload: {
  ...
  try {
    const response = await axios.post(
      `${API_BASE}NoObjectionCertificate/save`,
      payload,
    );
    return response.data;
  } catch (error) {
...
export const deleteNoObjectionCertificate = async (id: string) => {
  try {
    const response = await axios.delete(
      `${API_BASE}NoObjectionCertificate/delete/${id}`,
    );
    return response.data;
  } catch (error) {
...
export const getNoObjectionCertificatePrintData = async (ssno: string) => {
  try {
    const response = await axios.get(
      `${API_BASE}NoObjectionCertificate/print-data`,
      {
        params: { ssno },
      },
    );
    ...
    console.error(
      "Error while fetching No Objection Certificate print data",
      error,
    );
    throw error;
  }
...
export const getTcStudentDetails = async (regNo: string) => {
  try {
    const response = await axios.get(
      `${API_BASE}Tcissues/student-details/${encodeURIComponent(regNo)}`,
    );
    return response.data;
  } catch (error) {
...
export const getDelInActiveProgrammes = async (academicYear?: string) => {
  try {
    const acyr = academicYear || localStorage.getItem("academicYear") || "";
    const response = await axios.get(
      `${API_BASE}DelInActiveStudent/programmes`,
      {
        params: { academicYear: acyr },
      },
    );
...
export const getDelInActiveYears = async (
  programme: string,
  academicYear?: string,
) => {
  try {
...
export const getDelInActiveBranches = async (
  programme: string,
  academicYear?: string,
) => {
  try {
...
export const getDelInActiveSections = async (
  programme: string,
  branch: string,
  syear: string,
) => {
...
export const getDelInActiveStatuses = async (
  programme: string,
  branch: string,
  syear: string,
) => {
...
export const deleteInActiveStudents = async (payload: {
  ...
  try {
    const response = await axios.post(
      `${API_BASE}DelInActiveStudent/delete`,
      payload,
    );
    return response.data;
  } catch (error) {
...
export const getStudentInfoProgrammes = async (academicYear?: string) => {
  try {
    const acyr = academicYear || localStorage.getItem("academicYear") || "";
    const response = await axios.get(
      `${API_BASE}StudentInformation/programmes`,
      {
        params: { academicYear: acyr },
      },
    );
...
export const getStudentInfoBranches = async (
  programme: string,
  academicYear?: string,
) => {
  try {
...
export const getStudentInfoYears = async (
  programme: string,
  academicYear?: string,
) => {
  try {
...
export const getStudentInfoFilterOptions = async (columnName: string) => {
  try {
    const response = await axios.get(
      `${API_BASE}StudentInformation/filter-options`,
      {
        params: { columnName },
      },
    );
    ...
    console.error(
      `Error while fetching filter options for ${columnName}`,
      error,
    );
    throw error;
  }
...
export const generateStudentInfoReport = async (payload: {
  ...
  try {
    const response = await axios.post(
      `${API_BASE}StudentInformation/report`,
      payload,
    );
    return response.data;
  } catch (error) {
