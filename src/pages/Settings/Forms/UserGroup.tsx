...
import { fetchDept, fetchUsergroup, fetchUserGroupEmpList, updateUserGroups } from '../../../apis/SettingsApis'
   ...
   const onCancel = () => {
    ...
    return (
        <div className="dbs-usergroup-container">
            {/* Header */}
            <div className="dbs-usergroup-form-header">
                <h2>User Group</h2>
            </div>
            ...
            <div className="dbs-form-card">
                ...
                <div className="dbs-form-grid-3">
                    <div className="dbs-input-box">
                        ...
                        <select value={selectedDepartments} onChange={(e) => setSelectedDepartments(e.target.value)}>
                    ...
                    <div className="dbs-input-box">
                        ...
                        <select value={selectedUserGroup} onChange={(e) => setSelectedUserGroup(e.target.value)}>
                            <option value="">{loadingUserGroups ? "Loading..." : "Select User Group"}</option>
                            {userGroups.map((ug) => (
                                        ...
                                        <tr key={Emplist.eMPID}>
                                            ...
                                            <td>
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        handleCheckboxChange(Emplist.eMPID, e.target.checked)
                                                    }
                                                />
                                            </td>
                                        </tr>
